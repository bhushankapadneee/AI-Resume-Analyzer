...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='BinaryProtocol-V12',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Bhushan Kapadne</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                name = resume_data.get('name') or "there"
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Bhushan Kapadne</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Bhushan Kapadne' and ad_password == 'ByteShift-V8':
                ...
                st.success("Welcome Bhushan ! Total %d " % values + " User's Have Used Our Tool : )")                
